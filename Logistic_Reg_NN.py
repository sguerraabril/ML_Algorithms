...
def optimize(w, b, X, Y, num_iterations=100, learning_rate=0.009, print_cost=False):
    """
    This function optimizes w and b by running gradient descent
    ...
    for i in range(num_iterations):        
        ...
        # Record and/or print the costs every 100 training iterations
        if i % 100 == 0:
            costs.append(cost)
            if print_cost:
...
def predict(w, b, X):
    ...
    # Make predictions for each datapoint based on sigmoid probabilities
